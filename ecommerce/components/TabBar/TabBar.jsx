...
const TabBar = ({ tabData ,setTab,tab }) => {
  return (
    <div className="flex w-full gap-10  text-sm mt-4 border-b-2 border-main-text   font-bold text-black bg-main-bg items-center flex-initial whitespace-nowrap scrollbar-hide  overflow-x-auto  ">
