// components/PaymentSuccessClient.js
"use client";
...
// Dynamically import PaymentVerification component
const PaymentVerification = dynamic(() => import("../../components/checkout/paymentVerify"), {
  suspense: true,
});
