    ...
    return (
        <div>
            <div className='border rounded-sm border-main-text flex flex-col !h-[350px] w-full '>
                <div className='border cursor-pointer rounded-sm !h-[240px] w-full'>
                    <Image
                        src={value["image"]}
                        height={500}
                        width={500}
                        ...
                        <div className=''>
                            <Link href="#_" className="inline-flex overflow-hidden text-white bg-gray-900 rounded group">
                                <span className="px-2 py-1 text-white bg-main-text group-hover:bg-purple-600 flex items-center justify-center">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                                </span>
